...
class PerfilFragment : Fragment() {
    ...
    private lateinit var tvPerfilCurp: TextView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvPerfilCurp = view.findViewById(R.id.tvPerfilCurp)
    ...
    private fun actualizarUI(paciente: PacientePerfilResponse?) {
        ...
        tvPerfilNombre.text = paciente.nombreCompleto?.ifBlank { null }
            ?: sessionManager.getNombre().ifBlank { "Paciente" }
        tvPerfilTelefono.text = paciente.telefono?.ifBlank { null }
            ?: sessionManager.getTelefono().ifBlank { "No disponible" }
        tvPerfilCorreo.text = paciente.correo?.ifBlank { null }
            ?: sessionManager.getCorreo().ifBlank { "No disponible" }
        ...
        tvPerfilCurp.text = (paciente.curp ?: "").ifBlank { "--" }
